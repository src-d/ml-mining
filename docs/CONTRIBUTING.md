...
ml-mining project is [Apache licensed](../LICENSE.md) and accepts contributions via GitHub pull 
...
* GitHub [issues](https://github.com/src-d/ml-mining/issues)\*
...
Pull Requests \(PRs\) are the main and exclusive way to contribute to the official sourced.ml.mining project. In order for a PR to be accepted it needs to pass a list of requirements:
